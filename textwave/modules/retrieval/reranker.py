...
class Reranker:
    ...
    def sequential_rerank(self, query, context, top_k=10):
        """
        Sequentially rerank using TF-IDF for initial ranking and cross-encoder for final ranking.

        :param query: The query string for ranking.
        :param context: List of document chunks to be ranked.
        ...
        return cross_encoder_ranked_docs, cross_encoder_indices, cross_encoder_scores
    
    def tfidf_corpus_rerank(self, query, corpus, distance_metric="cosine"):
        """
        Ranks all documents in the corpus using TF-IDF similarity.

        :param query: The query string for ranking.
        :param corpus: List of all document chunks in the corpus.
